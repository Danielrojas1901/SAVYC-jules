...
class ReporteClientes
{
    ...
    public function __construct()
    {
        ...
        $this->listado = $this->obj->consultar();
    }
...
<page backtop="7mm" backbottom="10mm">
    ...
    <tr>
        <td style="text-align:left; border: none";>';
            //TUVE PROBLEMAS CON LA IMAGEN, POR ESO LA QUITE TEMPORALMENTE
    ...
    <h1 style="text-align:center;">Listado de Clientes</h1>
        <table id="t">
            ...
            <tbody>';
            foreach ($this->listado as $cliente) {
                $html .= '
                <tr>
        ...
        // Retorna el PDF como string para que el test pueda usarlo :)
        return $html2pdf->output('', 'S');
    }
}

//PARA QUE FUNCIONE EL MISMO CODIGO DE REPORTE TUVE QUE COLOCAR EN UNA CLASE